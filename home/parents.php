...
<form action="get-parent.php" method="post">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">Parents/Guardians</h3>
        <div class="card my-3 col-md-4 offset-md-4">
            <div class="card-body">
                <form action="" id="login-form">
                <div class="form-group">
                    <div class="form-group">
                        <label for="fullname" class="control-label">Student Full Name</label>
